...
public class Record {
    ...
    public String toString() {
        return "Record{" +
                ...
                ", ADMIN_CRT_TMSTAMP=" + formatLocalDateTime(ADMIN_CRT_TMSTAMP) +
                ", BL_GRP_NO=" + BL_GRP_NO +
                ", MTN_EFF_DT=" + formatLocalDate(MTN_EFF_DT) +
                ", ADMIN_EFF_DT=" + formatLocalDate(ADMIN_EFF_DT) +
                ", ADMIN_CHG_AMT=" + ADMIN_CHG_AMT +
                ", BL_PER_FROM_DT=" + formatLocalDate(BL_PER_FROM_DT) +
                ", BL_PER_TO_DT=" + formatLocalDate(BL_PER_TO_DT) +
                ", ADMIN_FEE_RSN_CD='" + ADMIN_FEE_RSN_CD + '\'' +
                ", DISCNT_OFFR_ID=" + DISCNT_OFFR_ID +
                ", VISION_USER_ID_CD='" + VISION_USER_ID_CD + '\'' +
                ", ORIG_ADMIN_TMSTAMP=" + formatLocalDateTime(ORIG_ADMIN_TMSTAMP) +
                ...
                ", CSEQ_IND='" + CSEQ_IND + '\'' +
                ", DB_USERID='" + DB_USERID + '\'' +
                ", DB_TMSTAMP=" + formatLocalDateTime(DB_TMSTAMP) +
                ...
                ", ORIG_CREATE_TS=" + formatLocalDateTime(ORIG_CREATE_TS) +
                ", INSTALL_LOAN_NO=" + INSTALL_LOAN_NO +
                ", V2_USER_ID='" + V2_USER_ID + '\'' +
                ", V2_UPDATE_DTM=" + formatLocalDate(V2_UPDATE_DTM) +
